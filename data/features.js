...
export const iconBoxData = [
  {
    ...
    title: "Free Shipping",
    description: "Enjoy free shipping on orders over 3,000 THB.",
  },
  {
    iconClass: "icon-payment fs-22",
    title: "Flexible Payment",
    description: "Supports credit cards, bank transfers, and mobile banking.",
  },
  {
    iconClass: "icon-return fs-20",
    title: "Easy Returns",
    description: "Hassle-free returns and exchanges within 14 days.",
  },
  {
    iconClass: "icon-suport",
    title: "24/7 Customer Support",
    description: "Available 24 hours a day, 7 days a week. Help is just a click away.",
  },
  {
  ...
  },
  {
    ...
    description: "High-quality products crafted with the finest materials.",
  },
  {
    iconClass: "icon-warranty",
    title: "Warranty Protection",
    description: "Warranty coverage for extra peace of mind.",
  },
  {
...
export const iconBoxes7 = [
  {
    iconClass: "icon-shipping",
    iconStyle: "",
    title: "ฟรีค่าจัดส่ง", // Free Shipping
    description: "จัดส่งฟรีเมื่อสั่งซื้อมากกว่า 3,000 บาท", // Free shipping for orders above 3,000 THB
  },
  {
    iconClass: "icon-payment",
    iconStyle: "fs-22",
    title: "การชำระเงินที่หลากหลาย", // Flexible Payment
    description: "รองรับการชำระผ่านบัตรเครดิตและโอนเงินผ่านธนาคาร", // Supports Credit Card and Bank Transfers
  },
  {
    iconClass: "icon-return",
    iconStyle: "fs-20",
    title: "การคืนสินค้าที่สะดวก", // Easy Returns
    description: "เปลี่ยนหรือคืนสินค้าได้ภายใน 14 วัน", // Exchange or return within 14 days
  },
  {
    iconClass: "icon-suport",
    iconStyle: "",
    title: "บริการลูกค้า", // Customer Support
    description: "พร้อมให้บริการตลอด 24 ชั่วโมง", // Available 24/7
  },
  {
    iconClass: "icon-secure",
    iconStyle: "",
    title: "ปลอดภัย มั่นใจได้", // Secure Payment
    description: "ระบบชำระเงินและข้อมูลลูกค้าปลอดภัย 100%", // 100% Secure Payment System
  },
];
